...
public class forpwd extends HttpServlet
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	    ...
	    con=DriverManager.getConnection("jdbc:odbc:project","scott","tiger");		
		 ...
		 String emailide=req.getParameter("user_id");
		pw.print(emailide);
...
while(rs.next())
	{		
			...
			if((sques.equals(sq)) && (sans.equals(sa)))
				{
...
pw.println("<center><br><br><br><br><br><br><h1><b>Invalid details entered</b></h1><br>");
	pw.println("<a href='fpwd.html'><b>TRY AGAIN</b></a>");
