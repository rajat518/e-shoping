...
import java.text.*;
import java.sql.*;
public class ords extends HttpServlet
{
        Connection con=null;
	Statement ps=null;	
	ResultSet rs=null;
	    ...
	    con=DriverManager.getConnection("jdbc:odbc:project","scott","tiger");		
		 ...
		 pw.println("<html>");
			...
			pw.println("<table border=0 cellspacing=0 cellpadding=0><tr><td><img src='order.JPG' width=1000 height=135></td></tr>");
            	...
            	pw.println("<form  name=f2  action=order_send method=get>");
...
rs=ps.executeQuery("select orderdetails.orderid,orderdetails.pro_id,orderdetails.user_id,orderdetails.pro_qty,orderdetails.branch_id,orders.ord_status from orderdetails,orders where orderdetails.orderid=orders.orderid and orderdetails.orderid='"+uid+"'");
		...
		while(rs.next())
          ...
          pw.println("<tr bgcolor=white><td><center><input type=checkbox name=n value="+orderid+"></td><td>"+orderid+"</td><td>"+pro_id+"</td><td>"+user_id+"</td><td>"+pro_qty+"</td><td>"+branch_id+"</td><td>"+ord_Status+"</td></tr>");
