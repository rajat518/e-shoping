...
if(p==2)
	...
	while(rs8.next())
	{
		...
		//		pw.println("insert into orders(orderid,ord_add,ord_city,ord_state,ord_pincode,ord_time,ord_status,ord_price) values(seq4.NextVal,'"+s1+"','"+s2+"','"+s3+"',"+s5+",'"+tim.format(d)+"','NEW',"+sum1+")");
				//row=ps.executeUpdate("insert into orders(orderid,ord_add,ord_city,ord_state,ord_pincode,ord_time,ord_price) values(seq4.NextVal,'"+s1+"','"+s2+"','"+s3+"',"+s5+",'"+tim.format(d)+"',"+sum1+")");
				con.commit();
...
//				pw.println("insert into orderdetails(orderid,pro_id,user_id,pro_price,pro_qty,branch_id,dpro_qty) values("+orderid+",'"+productid+"','"+ses.getAttribute("cuser_id")+"',"+sum+","+qty+",'"+br1+"',"+k+");");
				row1=ps2.executeUpdate("insert into orderdetails(orderid,pro_id,user_id,pro_price,pro_qty,branch_id) values("+orderid+",'"+productid+"','"+ses.getAttribute("cuser_id")+"',"+sum+","+qty+",'"+br1+"')");
