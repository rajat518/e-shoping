...
import java.text.*;
import java.sql.*;
public class custmultidetails extends HttpServlet
{
       Connection con=null;
       Statement ps=null;
       ResultSet rs=null;
       ...
       RequestDispatcher rd;
               ...
               int p=0;
                         ...
                         rs1=ps.executeQuery("select * from user_details");
           ...
           int rows=0;
               ...
               while(rs1.next())
                       ...
                       pw.println("after statement exists");
           ...
           for(int k=0;k<rows;k++)
                       ...
                       rd=req.getRequestDispatcher("multi.jsp");
                               rd.include(req,res);
