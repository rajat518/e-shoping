...
import java.text.*;
import java.sql.*;
public class supcheck extends HttpServlet
{
        Connection con=null;
	Statement ps=null;	
	ResultSet rs=null;
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
	    ...
	    con=DriverManager.getConnection("jdbc:odbc:project","scott","tiger");		
		 ...
		 pw.println("<html>");
           ...
           pw.println("<p><table cellpadding=1 cellspacing=1 border=1><th>product_name</th><th>product_id</th><th>branch_id</th><th>supplier_id</th><th>quantity</th><th>date</th></tr>");
		int i=1;
...
//String product_name,product_id,branch_id,supplier_id,dd;

            
	           int p=0;
              
rs=ps.executeQuery("select pro_name,pro_id,branch_id,supp_id,quantity,dd from sup_order where supp_id='"+ses.getAttribute("supp_id")+"'");
		...
		while(rs.next())
          ...
          pw.println("<tr bgcolor=white><td>"+product_name+"</td><td>"+product_id+"</td><td>"+branch_id+"</td><td>"+supplier_id+"</td><td>"+quantity+"</td><td>"+dd+"</td></tr>");
